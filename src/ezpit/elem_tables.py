...
AFF_PARAMETERS: list[list[float]] = [
    [
        0.413048,
        15.569946,
        0.294953,
...
COMPTON_ATOMIC_NUMBERS: list[int] = [
    1,
    2,
    3,
    4,
...
COMPTON_PARAMETERS: list[list[float]] = [
    [
        0.262300014,
        0.50940001,
        0.203400001,
...
def get_compton_scattering_factors(
    atom_names: list[str],
) -> tuple[np.ndarray[tuple[int, int], np.dtype[np.float32]], list[int]]:
